  ...
  return (
    <div ref={forwardedRef} className="flex flex-col md:flex-row gap-8 items-center justify-center p-4 bg-gray-50">
      ...
      <div className="w-[320px] h-[490px] bg-white rounded-3xl shadow-xl overflow-hidden relative border border-gray-200 flex flex-col font-sans select-none">
        ...
        <div className="absolute top-0 left-0 w-full h-[120px] overflow-hidden pointer-events-none z-0">
          {/* Top dark blue band */}
          ...
          {/* Wave curve overlay */}
          <svg viewBox="0 0 320 80" className="absolute top-[39px] left-0 w-full h-[50px] fill-current text-[#0A2342] z-10">
            <path d="M0,0 Q80,45 160,15 T320,0 L320,0 L0,0 Z" />
          </svg>
          <svg viewBox="0 0 320 80" className="absolute top-[41px] left-0 w-full h-[52px] fill-current text-green-600 z-0">
            <path d="M0,0 Q80,50 160,20 T320,0 L320,0 L0,0 Z" />
          </svg>
        </div>

        {/* Top Logo & Slogan Area */}
        <div className="relative z-20 pt-[48px] px-4 flex flex-col items-center shrink-0">
        ...
        <div className="flex-1 px-6 pt-3 flex flex-col relative z-20">
           ...
           <div className="space-y-2">
             <div className="flex items-start gap-2.5">
               ...
               <p className="text-[9.5px] text-gray-700 font-semibold leading-tight">
                 Medoxnity Diagnostics Pvt. Ltd.<br/>
             ...
             <div className="flex items-center gap-2.5">
               ...
               <p className="text-[9.5px] text-gray-700 font-semibold">corporate@medoxnity.com</p>
             </div>
           ...
           <div>
             ...
             <ul className="text-[8.5px] text-gray-700 space-y-1 list-disc pl-4 font-semibold leading-tight">
               <li>This ID card is the property of Medoxnity Diagnostics Pvt. Ltd.</li>
